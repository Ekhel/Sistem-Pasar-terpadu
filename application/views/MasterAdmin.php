                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                              <a class="nav-link" href="<?php echo base_url()?>Admin"><i class="fas fa-fw fa-chart-pie"></i>Dashboard</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-rocket"></i>Data Referensi</a>
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                      ...
                                      <!--<li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo base_url('Admin')?>">Pegawai</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <!--<li class="nav-item">
                                ...
                                <div id="submenu-3" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo base_url()?>Home/kua_ppas">KUA  - PPAS</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#">KUA - Perubahan</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#">RENJA</a>
                                        </li>
                                        <li class="nav-item">
