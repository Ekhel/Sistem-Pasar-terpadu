          ...
          <div class="profile-head">
            ...
            <p class="proile-rating">Mulai Operasi : <span><?php echo $hasil->tanggal_mulai_operasi ?></span></p>
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false"><i class="fas fa-th-list"></i> Laporan</a>
                </li>
              </ul>
            </div>
          </div>
